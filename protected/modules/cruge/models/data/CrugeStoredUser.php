...
class CrugeStoredUser extends CActiveRecord implements ICrugeStoredUser
{
    ...
    */
    ...
    {
        return array('iduser', 'username', 'email', 'cedula', 'cbit', 'state', 'logondate');
    }
    ...
    */
    ...
    public function rules()
    {
        return array(
            ...
            array('username,email,cedula,cbit', 'required'),
            ...
            array('username,email,cedula', 'validate_unique'),
    ...
    public function attributeLabels()
    {
        return array(
            ...
            'cedula'=>'Cedula',// CAMPOS PERSONALIZADOS
            'cbit'=>'Cbit',// CAMPOS PERSONALIZADOS
    ...
    public function search()
    {
        ...
        $criteria->compare('cedula', $this->cedula, true);// CAMPOS PERSONALIZADOS
        $criteria->compare('cbit', $this->cbit, true);// CAMPOS PERSONALIZADOS
