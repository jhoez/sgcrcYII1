...
<div class='row' <?php echo $colorEspecialBkTaskTipoMenuitem;?> >
	<div class='col center-align grey'>
		<?php echo $data->name;?>
	</div>
	...
	<div class='col operacion'>
		<?php echo CHtml::link(
			CrugeTranslator::t("editar permisos"),
	...
	<div class='col operacion'>
		<?php
			$tit = CrugeTranslator::t("muestra aquellos objetos que hacen referencia a ")." ".$data->name."";
			if($count_ref > 0) {
	...
	<div class='col operacion operacion-eliminar'>
		<?php
			...
			echo CHtml::link(
				CHtml::image(Yii::app()->user->ui->getResource($imagen)),
				$url,
	...
	<div class='col descr'>
		<?php
			if(trim($data->description) != '')
				echo "<hr>"."<span class='description'>".$data->description."</span>";
		?>
	</div>
