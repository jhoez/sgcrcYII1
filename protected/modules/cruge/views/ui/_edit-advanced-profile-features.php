...
<div class='row form-group'>
	<h6 class="center-align"><?php echo ucfirst(CrugeTranslator::t("opciones avanzadas"));?></h6>
	<div class='field-group'>
		<div class='row'>
			...
			<?php echo $form->error($model,'state',array('class'=>'red-text darken-3')); ?>
		</div>
				...
				<div class="col s6">
					<div class="btn waves-effect waves-ligh">
						<?php echo CHtml::ajaxbutton(
							...
							array('success'=>'js:fnSuccess','class'=>'white-text')
						); ?>
					</div>
				</div>
			</div>
		...
		<?php }else{ ?>
			<div class="row">
				<div class="col s6">
					<div class="btn waves-effect waves-ligh">
						<input class="" type='button' value='<?php echo ucfirst(CrugeTranslator::t("reenviar correo de activacion"))?>' disabled='disabled'>
					</div>
				</div>
			</div>
		<?php } ?>
	...
	<div class='field-group'>
		...
		<h5 class="center-align"><?php echo ucfirst(CrugeTranslator::t("asignacion de roles"));?></h5>
		<p class='hind'>
