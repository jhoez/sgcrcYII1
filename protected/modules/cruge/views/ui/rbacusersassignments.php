...
<div class='crugepanel user-assignments-role-list'>
	<h4 class="center-align"><?php echo ucfirst(CrugeTranslator::t("Roles Disponibles"));?></h4>
	...
	<?php
		...
		foreach($rbac->roles as $rol){
			echo "<li class='btn' alt='".$rol->name."'>".$rol->name.$loader."</li>";
		}
	?>
	</ul>
</div>
...
<div class='crugepanel user-assignments-detail'>
	<h6 class="center-align"><div id='mostrarSeleccion'></div></h6>
		...
		$this->widget(Yii::app()->user->ui->CGridViewClass, array(
			...
			'columns'=>array(
				array(
					...
					'footerHtmlOptions'=>"",
					'checkBoxHtmlOptions'=>array('class'=>'checkbox-column'),
