...
if(Yii::app()->user->checkAccess('tutor')){
    $this->menu=array(
        array('label'=>"<i class='small material-icons'>assignment</i>", 'url'=>array('create'),'linkOptions'=>array('class'=>'btn-floating green')),
...
$image = CHtml::image(Yii::app()->baseUrl."/fonts/download.svg", 'link', array('title'=>'formato','id'=>''));
?>
    ...
    <div class="col s10 pull-l3 l6">
        ...
        <div class="row">
            ...
            <?php echo $form->dropDownList(
                $formato,'idf',
				CHtml::listData($formato::model()->findAll( array('condition'=>"opcion='acta' AND update_ad=1 ") ),'idf', 'nombf'),
				array(
...
<script type="text/javascript">
	<?php if(Yii::app()->user->hasFlash('formatoD')){ ?>
		window.addEventListener('load', function(){
			Swal.fire({
				icon: 'success',
				title: "<?php echo Yii::app()->user->getFlash('formatoD')?>",
