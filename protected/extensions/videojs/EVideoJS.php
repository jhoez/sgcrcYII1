...
class EVideoJS extends CWidget
{
	...
	public function run()
	{
		 ...
		 */
		echo "<!-- Begin VideoJS --><div id='$id' class='video-js-box'>\n";
		/*
		 * Video tag
		 */
		...
		if ($download) {
			...
			$imag = CHtml::image(Yii::app()->baseUrl."/fonts/download.svg", 'link', array('title'=>'descarga'));

			if ($video_mp4) {
				echo "DESCARGAR MP4 ".CHtml::link($imag,array("../../$video_mp4"),array('target'=>'_blank','class'=>'green-text'));
				//echo '<a href="', $video_mp4, '">Download Video MP4</a>', "\n";
			}
			if ($video_webm) {
				echo '<a href="', $video_webm, '">Download Video WebM</a>', "\n";
			}
			if ($video_ogv) {
				echo '<a href="', $video_ogv, '">Download Video Ogg</a>', "\n";
			}
